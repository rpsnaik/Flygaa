...
class UserData{
  ...
  UserData({@required this.uid, @required this.name, @required this.dateOfBirth, @required this.email, @required this.gender, @required this.userProfileImage, @required this.governmentId, @required this.emergencyContact, @required this.favirouteDestinations});
